...
Start:
	...
	int 21h					;DOS
	mov DX, OFFSET MyName	;строку MyName на экран спомощью
	int 21h					;DOS
	mov DX, OFFSET MyGroup	;строку MyGroup на экран спомощью
	int 21h					;DOS
...
Data SEGMENT	;Открыть сегмент данных
	...
	MyName DB 'My name is Egor', 13, 10, '$'	;Определить строку символов с именем Greet
	MyGroup DB 'My group is KB-91', 13, 10, '$'	;Определить строку символов с именем Greet
