...
.DATA	;Открыть сегмент данных
	...
	forcolor DB 0Fh	;Белый цвет
	xc DW 130	;Координаты центра
	yc DW 100	;окружности
	rx DW 80	;Значения радиуса по оси x
	ry DW 82	;Значения радиуса по оси y
	xc_yc DB '130,100','$'	;Выводимые значения координат
;=============================Переменные=============================
...
Simv PROC	;Начать процедуру с именем Simv
	...
	mov DL, 17	;Номер столбца - 20
	mov DH, 11	;Номер строки - 12
...
;Подготовка данных
	...
	mov x, 0	;Установить значения x и y
	mov y, 0	;равными 0 (центр окружности)
	mov AL, 04h	;Цвет - красный
	call Point	;Вывести пиксел
